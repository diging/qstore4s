...
/**
 * Test class to test the getStatistics() method of the Statistics class
 * 
...
public class QStoreStatisticsTest {
    ...
    public void testGetStatistics() throws InvalidDataException {
        ...
        assertEquals(Integer.valueOf(5),
                Integer.valueOf(statisticsMap.get(IStatistics.APPELLATIONS)));
        assertEquals(Integer.valueOf(2),
                Integer.valueOf(statisticsMap.get(IStatistics.RELATIONS)));
        assertEquals(Integer.valueOf(26),
                Integer.valueOf(statisticsMap.get(IStatistics.NODES)));
