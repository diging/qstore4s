...
/**
 * @author Bhargav Desai This class is used to get information of relation or
...
public class DbConnector implements IDbConnector {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(QStore.class);
    ...
    /**
     * The method builds where and match clause for relation events in neo4j
     * query.
     * 
     * @param queryObject
     * @param whereClause
    ...
    /**
     * The method builds where and match clause for appellation events in neo4j
     * query.
     * 
     * @param queryObject
     * @param whereClause
    ...
    /**
     * The method build where clause for given object and property values and
     * also consider weather property value is regualr expression or not.
     * 
     * @param name
     * @param property
     * @param value
    ...
    public List<CreationEvent> executeQuery(String query, String clas) {
        Class<?> classs = null;
        if ("relationevent".equals(clas.toLowerCase())) {
            classs = RelationEvent.class;
        } else {
            classs = AppellationEvent.class;
        }

        Iterable<?> results = template.queryForObjects(classs, query, new HashMap<String, String>());
