...
public class XmltoObject extends AXmlParser implements IXmltoObject {
    ...
    public List<List<edu.asu.qstore4s.domain.elements.impl.Element>> parseXML(
    ...
    public RelationEvent getRelationEvent(
            Element relationEvent,
            Namespace nameSpace,
            List<edu.asu.qstore4s.domain.elements.impl.Element> referencedObjectList)
    ...
    public AppellationEvent getAppellationEvent(
            Element appellationEvent,
            Namespace nameSpace,
            List<edu.asu.qstore4s.domain.elements.impl.Element> referencedObjectList)
            throws ParserException, IOException, URISyntaxException,
            ParseException, InvalidDataException {
        ...
        if (checkForSpaces(appellationEventObject.getInternal_refId()) == null
            ...
            if (term != null) {
                ...
                throw new InvalidDataException(
                        "term for appellation is missing");
            }
    ...
    public Term getTermObject(
        ...
        if (termObject.getInternal_refId() == null
            ...
            Element interpretationElement = term.getChild(
            ...
            if (interpretationElement != null) {
                ...
                String datatype = interpretationElement
                        .getAttributeValue(IXmlElements.INTERPRETATION_DATATYPE);
                Concept concept = conceptFactory
                        .createConcept(checkForSpaces(interpretationValue));
     ...
     */
    public TermParts getTermPartsObject(
            Element printedRepresentation,
            Namespace nameSpace,
            List<edu.asu.qstore4s.domain.elements.impl.Element> referencedObjectList)
     ...
     */
    public Set<TermPart> getTermPartObject(
            Set<Element> TermPartNodes,
            Namespace nameSpace,
            List<edu.asu.qstore4s.domain.elements.impl.Element> referencedObjectList)
            throws ParseException {
        DateFormat formatter;
                ...
                termPartObject.setNormalization(vocabularyEntryFactory
                        .createVocabularyEntry(checkForSpaces(currentElement
                                .getChildText(IXmlElements.NORMALIZATION,
                                        nameSpace))));
                String position = checkForSpaces(currentElement.getChildText(
